    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb mb-2">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="index.html">Education Management System</a></li>
          <li class="list-inline-item text-white h3 font-secondary nasted">Faculty</li>
        </ul>
        <p class="text-lighten mb-0">Here the faculty can view the courses they are teaching and view personal info.</p>
      </div>
    </div>
  </div>
</section>
