  ...
  ?>
    ...
    <div class="container">
        ...
        <div class="col-md-8">
            ...
            <p class="text-lighten mb-0">Here is where you can add a faculty.</p>
        </div>
        </div>
    </div>
    </section>
    ...
    <div class="container">
        <div class="row">
        <div class="col-12">
            <h2 class="section-title">Add a Faculty</h2>
        </div>
        </div>
        ...
        <div class="col-12 mb-50">
            ...
            <div class="form" id="createAccount">
                <form method="post" action="run-add-fac.php">
                ...
                <label for="fac_DOJ">Faculty DOJ:</label>
                <input type="text" id="fac_DOJ" name="fac_DOJ">
                <br><br>
