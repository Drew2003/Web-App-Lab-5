  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        ...
        <p class="text-lighten mb-0">This is where the admin can view or add students and faculty, see departments, and see all courses.</p>
      </div>
    </div>
  </div>
</section>
        ...
        <div class="card border-0 rounded-0 hover-shadow">
          ...
          <div class="card-body">
            <a href="view-faculty.php">
              <h4 class="card-title">View All Faculty</h4>
            </a>
          </div>
